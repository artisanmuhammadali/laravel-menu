...
```php
ArtisanAli\Menu\MenuServiceProvider::class,
```

3. add facade in the file config/app.php (optional on laravel 5.5)

```php
'Menu' => ArtisanAli\Menu\Facades\Menu::class,
```

4. Run publish

```php
php artisan vendor:publish --provider="ArtisanAli\Menu\MenuServiceProvider"
```
...
```php
use ArtisanAli\Menu\Models\Menus;
use ArtisanAli\Menu\Models\MenuItems;
...
```php
use ArtisanAli\Menu\Facades\Menu;
...
/*
Parameter: Menu ID
Return: Array
