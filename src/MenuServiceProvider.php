...
class MenuServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->publishes([
            __DIR__ . '/../assets' => public_path('vendor/artisanali-menu'),
        ], 'public');
    ...
    {
        $this->app->bind('artisanali-menu', function () {
            return new WMenu();
        });

        $this->app->make('ArtisanAli\Menu\Controllers\MenuController');
