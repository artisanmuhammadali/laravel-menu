...
<script type="text/javascript" src="{{asset('vendor/artisanali-menu/scripts.js')}}"></script>
<script type="text/javascript" src="{{asset('vendor/artisanali-menu/scripts2.js')}}"></script>
<script type="text/javascript" src="{{asset('vendor/artisanali-menu/menu.js')}}"></script>