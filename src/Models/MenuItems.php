...
namespace ArtisanAli\Menu\Models;
...
class MenuItems extends Model
{
    ...
    {
        return $this->belongsTo('ArtisanAli\Menu\Models\Menus', 'menu');
    }

    public function child()
    {
        return $this->hasMany('ArtisanAli\Menu\Models\MenuItems', 'parent')->orderBy('sort', 'ASC');
    }
}
